...
<html lang="es">
    <head>
        ...
        <link href="<?= site_url(); ?>/public/css/dataTables.bootstrap4.min.css" rel="stylesheet"/>
        <script src="<?= site_url(); ?>/public/js/all.min.js"></script>
    </head>

    
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="<?= base_url() ?>">Punto de Venta</a>
